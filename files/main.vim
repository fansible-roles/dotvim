...
set autochdir                         " auto chdirectory
...
" --- Color Settings ---
highlight ColorColumn ctermbg=98        " set the colorcolumn bg to purple
...
" --- Auto Commands ---
autocmd VimEnter * runtime vimfiles/*.vim    "add vimfiles in runtimepath and autoload all
